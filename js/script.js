...
const translations = {
    pt: {
      ...
      blog: "Blog",
      contact: "Contato",
      heroTitle: "Transformando Ideias em Resultados",
      heroSubtitle: "Soluções inovadoras para otimizar processos na Engenharia de Produção e Logística.",
      ...
      servicesTitle: "Tecnologia e Inovação",
      ...
      testimonialsTitle: "Frases Estratégicas",
      testimonial1: "A logística eficiente, aliada à engenharia de produção, impulsiona negócios e reduz desperdícios.",
      testimonial2: "Inovação em logística é essencial para se adaptar às demandas do mercado.",
      blogTitle: "Blog",
    ...
    en: {
      ...
      blog: "Blog",
      contact: "Contact",
      heroTitle: "Transforming Ideas into Results",
      heroSubtitle: "Innovative solutions to optimize processes in Production Engineering and Logistics.",
      aboutTitle: "About Me",
      ...
      servicesTitle: "Technology and Innovation",
      ...
      service4: "Proven Results",
      service4Desc: "Apply data-driven strategies and innovative technologies to achieve metrics such as on-time deliveries (OTIF) and reduced logistics costs.",
      testimonialsTitle: "Strategic Phrases",
      testimonial1: "Efficient logistics, combined with production engineering, drives business and reduces waste.",
      testimonial2: "Innovation in logistics is essential to adapt to market demands.",
      blogTitle: "Blog",
